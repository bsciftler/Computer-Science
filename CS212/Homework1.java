...
public class Homework1 
	...
	//Extra Credit: A way to improve this method is having a "do while" loop in main that can be activated in CheckInteger
	//Currently, It will not only return false instead of attempting to ask the User again to put proper integers.
