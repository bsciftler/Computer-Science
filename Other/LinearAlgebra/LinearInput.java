...
public class LinearInput 
{
	public static void main (String [] args)
	{
		...
		*/
		...
		if(MatrixMath.triangular(MatrixA))
		{
		...
		if(MatrixMath.triangular(MatrixB))
		{
			JOptionPane.showMessageDialog(null,"UTM/LTM Matrix");
		}
		else
		...
		try 
		{
			ProductSolution=MatrixMath.Multiply(MatrixA,MatrixB);
		...
		try 
		{
			SumSolution=MatrixMath.Addition(MatrixA, MatrixB);
